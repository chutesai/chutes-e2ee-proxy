...
def test_env_resolution(monkeypatch) -> None:
    ...
    settings = Settings.from_cli(None, None, None, None, None, None, None)
...
@pytest.mark.parametrize(
    "kwargs",
    [
        {"host": None, "port": -1, "upstream": None, "e2e_upstream": None, "tunnel": None, "cloudflared_bin": None, "log_level": None},
        {"host": None, "port": None, "upstream": "not-a-url", "e2e_upstream": None, "tunnel": None, "cloudflared_bin": None, "log_level": None},
        {"host": None, "port": None, "upstream": None, "e2e_upstream": "not-a-url", "tunnel": None, "cloudflared_bin": None, "log_level": None},
        {"host": None, "port": None, "upstream": None, "e2e_upstream": None, "tunnel": "bad", "cloudflared_bin": None, "log_level": None},
        {"host": None, "port": None, "upstream": None, "e2e_upstream": None, "tunnel": None, "cloudflared_bin": None, "log_level": "bad"},
    ],
)
